...
export function SidebarHeader({ onClose }: { onClose: () => void }) {
  return (
    <div className="px-5 py-6 border-b border-[var(--card-border)] flex items-center justify-between">
      <div>
        <Link href="/" className="font-black text-[1.2rem] p-4 tracking-tight text-[var(--text-main)] no-underline">
